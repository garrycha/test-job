...
export default function Page2() {
  const [pageConfig, setPageConfig] = useState({ page2: [], page3: [] });
  ...
  useEffect(() => {
    try {
      ...
      if (currentUser?.page2) {
        setFormData(prev => ({ ...prev, ...currentUser.page2 }));
      }
    } catch (error) {
